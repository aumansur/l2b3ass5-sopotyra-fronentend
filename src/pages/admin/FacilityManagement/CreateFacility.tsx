    ...
    <Row justify="center" align="middle">
      <Col lg={10} className="p-8 shadow-lg rounded-lg bg-white" sm={12} md={6}>
        ...
        <SFform onSubmit={onSubmit}>
          ...
          <Form.Item>
            <SFInput type="text" label="Description" id="Description" name="description" />
          </Form.Item>
          <Form.Item>
            <SFInput type="number" label="Price Per Hour" id="PricePerHour" name="pricePerHour" />
          </Form.Item>
          <Form.Item>
            <SFInput type="text" label="Image" id="Image" name="image" />
          </Form.Item>
          <Form.Item>
            <SFInput type="text" label="Location" id="Location" name="location" />
          </Form.Item>
          <Button className="bg-primary text-white" htmlType="submit">Create Facility</Button>
        </SFform>
      </Col>
    </Row>
  );
